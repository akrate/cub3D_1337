...
/*   Updated: 2026/01/25 10:54:03 by aoussama         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int							check_space_sequence(char *str, int i,
								int space_count);
...
void						load_texture(t_data *data, t_img_tex *tex,
								char *path);
void						load_all_textures(t_data *data);
t_img_tex					*get_wall_texture(t_data *data, t_hit h,
								double rayDirX, double rayDirY);
t_hit						cast_ray_dda(t_data *data, double rayDirX,
								double rayDirY);
void						render_3d_walls(t_data *data);
void						put_pixel_to_img(t_mlx *mlx, int x, int y,
								int color);
